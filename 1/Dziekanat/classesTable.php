	...
	<div class="container">
		<div class="row">
			<div class="col-md-2">
			 ...
			 <div class="col-md-2">
            <div class="pull-left">
                <br/><button class="btn btn-success" data-toggle="modal" data-target="#add_student_to_class_modal">Zapisz studenta na przedmiot</button>
            </div>
        </div>
...
<!-- Modal - Dodawanie studenta do przedmiotu -->
	<div class="modal fade" id="add_student_to_class_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Zapisz studenta na przedmiot</h4>
				</div>
				<div class="modal-body">
					<div class="form-group">
					...
					<div class="form-group">
						...
						<select class="form-control" id="student_full_name2"><?php include 'ajax/selectStudent.php';?></select>
					</div>
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																				
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">Anuluj</button>
					<button type="button" class="btn btn-primary" onclick="addStudentToClass()">Zapisz</button>
				</div>
			</div>
		</div>
	</div>
